    ...
    return(
        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <div className="lg:w-1/2 relative w-full lg:h-auto h-64 object-cover object-center rounded">
            <Image
              fill={true}
              src="https://plus.unsplash.com/premium_photo-1661893870720-e2f6d09d96d7?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8ZG9jdG9yc3xlbnwwfHwwfHx8MA%3D%3D"
            />
          </div>
